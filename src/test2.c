...
int main() {
    ...
    TCase *s21_is_greater_or_equal_case = tcase_create("s21_is_greater_or_equal_case");
    ...
    TCase *s21_from_int_to_decimal_case = tcase_create("s21_from_int_to_decimal_case");
    ...
    TCase *s21_from_float_to_decimal_case = tcase_create("s21_from_float_to_decimal_case");
    suite_add_tcase(suite, s21_from_float_to_decimal_case);
    tcase_add_test(s21_from_float_to_decimal_case, s21_from_float_to_decimal_test);

    TCase *s21_from_decimal_to_int_case = tcase_create("s21_from_decimal_to_int_case");
    ...
    TCase *s21_from_decimal_to_float_case = tcase_create("s21_from_decimal_to_float_case");
    suite_add_tcase(suite, s21_from_decimal_to_float_case);
    tcase_add_test(s21_from_decimal_to_float_case, s21_from_decimal_to_float_test);
